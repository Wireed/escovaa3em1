      ...
      <div className="container">
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
          ...
          >
            ...
            <p className="text-muted-foreground text-sm sm:text-base mb-6 max-w-lg mx-auto lg:mx-0">
              A solução perfeita para cabelos mais lisos, hidratados e alinhados em minutos!
              Com tecnologia avançada, ela alisa, seca e reduz o frizz sem danificar os fios.
            </p>
            ...
            <div className="space-y-3">
              <div className="flex flex-col sm:flex-row items-center gap-3">
                <span className="text-muted-foreground line-through text-lg">R$ 199,90</span>
                <span className="font-heading font-black text-3xl sm:text-4xl text-gradient-primary">R$ 99,99</span>
                <span className="bg-success text-primary-foreground font-heading font-bold text-xs px-3 py-1 rounded-full">
                  -50% OFF
                </span>
              </div>
              <p className="text-muted-foreground text-sm">ou 12x de R$ 8,33 sem juros</p>
              ...
              <motion.a
                ...
                whileTap={{ scale: 0.97 }}
                className="inline-block gradient-primary text-primary-foreground font-heading font-bold text-lg sm:text-xl px-8 sm:px-12 py-4 sm:py-5 rounded-xl glow-primary animate-pulse-glow uppercase tracking-wide w-full sm:w-auto text-center"
              >
                🛒 Comprar Agora
              </motion.a>

              <p className="text-xs text-muted-foreground flex items-center justify-center lg:justify-start gap-1">
                🔒 Compra 100% Segura — Pague na Entrega
              </p>
            </div>
          </motion.div>
